...
public class MainActivity8_1_BzuMap extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(MainActivity8_1_BzuMap.this, MainActivity5_studentHome.class);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            Intent intent = new Intent(this,  MainActivity8_2_BzuMap.class);
            intent.putExtra("stud_id", id);
            startActivity(intent);
        }
    }
